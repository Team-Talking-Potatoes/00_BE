...
// 		CreateGatheringResponse response = gatheringService.integrateGatheringCreation(req, null, user1.getId());
//
// 		// then
...
// 			.build();
//
// 		when(gatheringRepository.findByIdAndCanceledAtIsNull(gatheringId)).thenReturn(Optional.of(gathering));
...
// 			request.type(),
// 			request.location(),
// 			DateTimeUtils.getStartOfDay(request.date()),
// 			DateTimeUtils.getEndOfDay(request.date()),
// 			request.createdBy(),
// 			pageable
